...
if (count($search_results) > 10) {
  ...
  $limited_search_query_string = "SELECT firstname, lastname, dorm, profile_pic_url FROM person WHERE '" . $basic_search_query . "' LIKE '%' || firstname || '%' OR '" . $basic_search_query . "' LIKE '%' || lastname || '%' LIMIT;";
...
=======
  ...
  <div class="hero-image">
    <div class="hero-text" align="center">
     <h1>Welcome to Westmont Student Finder</h1>
>>>>>>> 569a5d714c87d4ef423380f4a2af40d4cf6ba80f
   </div>
 </div>
    ...
    <?php
      if (empty($search_results)) {
        ...
        foreach ($search_results as $key=>$value) {
         ...
         echo "<p>" . $value['dorm'] . "</p>";
         echo "<p><a href=\"http://bminer-apps/?sid=" . $value['student_id'] . "\">Profile</a>";
         echo "</li>";
       }
      }
